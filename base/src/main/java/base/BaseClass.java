...
public class BaseClass {  public static WebDriver driver;
    ...
    public static ExcelDataRead dataReader = new ExcelDataRead();
    ...
    public static void beforeEachMethodExtentInit(Method method) {
        ...
        ExtentTestManger.startTest(methodName);
    ...
    public void extentFlush(ITestResult result) {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ExtentTestManger.getTest().log(LogStatus.FAIL, "TEST CASE FAILED: " + result.getName());
            ExtentTestManger.getTest().log(LogStatus.FAIL, result.getThrowable());
            captureScreenshot(driver, result.getName());
        } else if (result.getStatus() == ITestResult.SKIP) {
            ExtentTestManger.getTest().log(LogStatus.SKIP, "TEST CASE SKIPPED: " + result.getName());
        } else if (result.getStatus() == ITestResult.SUCCESS) {
            ExtentTestManger.getTest().log(LogStatus.PASS, "TEST CASE PASSED: " + result.getName());
        }
